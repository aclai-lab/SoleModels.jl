...
# get_featurenames(tree::DT.InfoNode)::Vector{Symbol} = tree.info.featurenames
...
function SoleModels.propositional_solemodel(
    ...
    trees = map(t -> SoleModels.propositional_solemodel(t; classlabels, featurenames), model.trees)
...
function SoleModels.propositional_solemodel(
    ...
    root = SoleModels.propositional_solemodel(tree.node; classlabels, featurenames)
    DecisionTree(root, (;))
end
...
function SoleModels.propositional_solemodel(
    ...
    cond = get_condition(tree.featid, tree.featval, featurenames)
    antecedent = Atom(cond)
    lefttree  = SoleModels.propositional_solemodel(tree.left;  classlabels, featurenames)
    righttree = SoleModels.propositional_solemodel(tree.right; classlabels, featurenames)
