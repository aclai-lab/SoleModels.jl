...
begin
	...
	# Print ruleset
	printmodel.(ruleset; show_metrics = true, threshold_digits = 2, variable_names_map = [names(X_df2)], parentheses_at_propositions = false);
end
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "f989ae379ca4f6ad133aa6aea83ace75cd4df6f5"
