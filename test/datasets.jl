...
@test_nowarn DimensionalFeaturedDataset{Float64}(X, ontology, [ModalLogic.CanonicalFeatureGeq(), ModalLogic.CanonicalFeatureLeq()])

dfd = @test_nowarn DimensionalFeaturedDataset(X, ontology, [ModalLogic.CanonicalFeatureGeq(), ModalLogic.CanonicalFeatureLeq()])
