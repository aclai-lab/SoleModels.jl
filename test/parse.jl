using SoleModels.DimensionalDatasets: parsecondition
...
@test_nowarn SoleModels.parsecondition("max{3] <= 12"; featvaltype = Float64, opening_bracket="{", variable_name_prefix = "")
@test_nowarn SoleModels.parsecondition("  min[V4}    > 43.25  "; featvaltype = Float64, closing_bracket="}")
@test_nowarn SoleModels.parsecondition("max{5} <= 250"; featvaltype = Float64, opening_bracket="{", closing_bracket="}", variable_name_prefix = "")
@test_nowarn SoleModels.parsecondition("mean[V9] <= 1.0e100"; featvaltype = Float64)
...
@test_throws AssertionError SoleModels.parsecondition("max{18] <= 12"; opening_bracket="}", variable_name_prefix = "")
